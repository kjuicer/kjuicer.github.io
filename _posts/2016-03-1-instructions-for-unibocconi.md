...
![]({{site.url}}/post_assets/instructions/highlighters bar.png)

on mobile:

![]({{site.url}}/post_assets/instructions/highlighters bar - mobile.png)

To reach the ***highlighters' bar*** you need to click the "Edit" botton, the leftmost button of the ***viewing bar***;

![]({{site.url}}/post_assets/instructions/viewing bar.png)

on mobile:

![]({{site.url}}/post_assets/instructions/viewing bar - mobile.png)
...
![]({{site.url}}/post_assets/instructions/highlighters bar undo - mobile.png)
...
![]({{site.url}}/post_assets/instructions/Statistics etc.png)
...
![]({{site.url}}/post_assets/instructions/menu_new - mobile.png)
